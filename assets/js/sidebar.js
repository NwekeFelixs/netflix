...
export function sidebar (){
    ...
    sidebarInner.innerHTML = `
        ...
        <div class="sidebar-list">
            ...
            <a href="./movie-list.html" menu-close class="sidebar-link" onclick='getMovieList("with_original_language=cn", "Cantonese")'>Cantonese</a>
            ...
            <a href="./movie-list.html" menu-close class="sidebar-link" onclick='getMovieList("with_original_language=ig", "Igbo")'>Igbo</a>

            <a href="./movie-list.html" menu-close class="sidebar-link" onclick='getMovieList("with_original_language=ha", "Hausa")'>Hausa</a>
        ...
        <div class="sidebar-footer">
            <p class="copyright">
                copyright 2023 &copy; <a href="https://github.com/NwekeFelixs">Feylcks</a> 
            </p>

            <img src="./assets/images/Netflix-Logo.wine.svg" alt="" width="130" height="17">
        </div>
    `;
